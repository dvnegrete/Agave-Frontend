...
// Request para asignación (renombrado para evitar conflicto con user-management)
export interface DepositAssignHouseRequest {
  houseNumber: number;
  adminNotes?: string;
  [key: string]: unknown;
}
...
export interface DepositAssignHouseResponse {
  message: string;
  reconciliation: {
    transactionBankId: string;
    houseNumber: number;
