    ...
    },
    {
      ...
      render: (user) => {
        ...
        if (user.auth_provider === 'password') {
          return (
            <span className="inline-flex items-center gap-1.5 text-sm text-foreground">
              <svg className="w-4 h-4 text-foreground-secondary" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
        ...
        return <span className="text-foreground-tertiary text-sm">-</span>;
      },
    },
    {
      id: 'observations',
