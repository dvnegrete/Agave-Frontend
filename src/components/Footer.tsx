      ...
      <div className="max-w-6xl mx-auto px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-start gap-3">
            <svg
              className="w-6 h-6 mt-1 flex-shrink-0 text-foreground"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <div className="flex items-start gap-3">
            <svg
              className="w-6 h-6 mt-1 flex-shrink-0 text-success"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <div className="flex items-start gap-3">
            <svg
              className="w-6 h-6 mt-1 flex-shrink-0 text-info"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        {/* Copyright */}
        <div className="mt-3 pt-2 border-t border-base text-center text-foreground-tertiary text-sm">
